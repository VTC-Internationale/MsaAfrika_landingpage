    ...
    <nav className="p-4 py-5 bg-white text-black fixed w-full font-geist-sans">
      ...
      <div className="bg-[#ef9c9c] absolute top-0 right-0 h-100vh w-[80%]">
        <ul className="flex flex-col justify-center items-center gap-10 mt-10">
          ...
          <li>
            <Link href="#">
              <p className="text-[#4C535D] font-normal text-[14px]">Produits</p>
            </Link>
          </li>
          <li>
            <Link href="#">
              <p className="text-[#4C535D] font-normal text-[14px]">Services</p>
            </Link>
          </li>
          <li>
            <Link href="#">
              <p className="text-[#4C535D] font-normal text-[14px]">À propos</p>
            </Link>
          </li>
          <li>
            <Link href="#">
              <p className="text-[#4C535D] font-normal text-[14px]">Contact</p>
            </Link>
          </li>
        </ul>
        <div>
